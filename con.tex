...
В конечном итоге мы хотели бы написать \textsc{lock-free} бор, который будет способен быстро обрабатывать запросы, не ломаться в случаях аварийных завершений и разумно работать с оперативной памятью
