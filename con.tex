...
Заметьте как получается использовать время другого потока, потраченное на помощь, чтобы развернуть бесконечный цикл в конечное исполнение на всей системе. Мы будем использовать это дальше в \textsc{lock-free} очереди Майкла и Скотта, которая использует эту технику для поддержания одного свойства системы
